...
you can use the website to see the products available withouth logging in or registering, but in order for you to buy anything you have to login(or register if you don't have a account already).
 ...
 <br>
 - The project has to have more than one routes - used routing module;
 ...
 - At least one page with a form - I have a Login/ Register page; 
 ...
 - Firebase or any other medium for backend. - used the base project for DAW with .NET C# .
