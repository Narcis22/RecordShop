...
namespace RecordShop.BLL.Helper
{
    /// <summary>
    /// Standard Token Helper witn a 10 min expiration window and a hs256 encoder
    /// </summary>
    public class TokenHelper : ITokenHelper
    {
        ...
        public TokenHelper(IConfiguration config, UserManager<User> userManager)
        {
        ...
        public async Task<string> CreateAccessToken(User user)
        {
            ...
            var secret = _config.GetSection("Jwt").GetSection("Token").Get<String>();
        ...
        public ClaimsPrincipal GetPrincipalFromExpiredToken(string _Token)
        {
            var tokenValidationParameters = new TokenValidationParameters
            {
                ...
                IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_config["Jwt:Token"])),
