        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArtistInfo_Artist_ArtistId",
                        column: x => x.ArtistId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Remix = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SongCarts_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongCarts_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongCarts_CartId",
                table: "SongCarts",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_SongCarts_SongId",
                table: "SongCarts",
                column: "SongId");
